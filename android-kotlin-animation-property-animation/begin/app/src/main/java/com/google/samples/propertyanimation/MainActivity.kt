...
class MainActivity : AppCompatActivity() {
    ...
    //function to disable buttons while animations are executing
    //highOrderFunction to disable buttons
    ...
    private fun shower() {
        //get the parents image size
        val container = star.parent as ViewGroup

        //set the widht and the height
        val containerW = container.width
        val containerH = container.height

        //get the star widht and height
        ...
        //do the new stars to down
        val mover = ObjectAnimator.ofFloat(
            newStar, View.TRANSLATION_Y,
            -starH, containerH + starH
        )
        //acelerate the new star
        ...
        val set = AnimatorSet()
        //move down and rotate together
        set.playTogether(mover, rotator)
        set.duration = (Math.random() * 1500 + 500).toLong()
        //remove new start when the animation ends
