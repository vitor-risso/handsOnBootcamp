...
public final class WithdrawFragmentBinding implements ViewBinding {
  ...
  private WithdrawFragmentBinding(@NonNull LinearLayout rootView, @NonNull Button btnDeposit,
  ...
  @NonNull
  public static WithdrawFragmentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static WithdrawFragmentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.withdraw_fragment, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static WithdrawFragmentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new WithdrawFragmentBinding((LinearLayout) rootView, btnDeposit, depositFragment,
